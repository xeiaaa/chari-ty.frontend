...
export default function NotificationsPage() {
  ...
  if (notificationsLoading) {
    return (
      <div className="max-w-6xl mx-auto">
        <PageHeader
          title="Notifications"
          message="Manage your notifications and stay updated with your fundraising activities"
        />
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <PageHeader
        title="Notifications"
        message={`${unreadCount?.count || 0} unread ${
            ...
            {notifications.map((notification) => {
              ...
              return (
                <Card
                  key={notification.id}
                  className={cn(
                    "transition-all duration-200 hover:shadow-md py-2",
