  ...
  return (
    <div className="max-w-6xl mx-auto">
      <PageHeader
        ...
        message="Welcome to the admin panel. Manage your platform from here."
      />
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium">Fundraiser created</p>
                    <p className="text-xs text-muted-foreground">
                      15 minutes ago
                    </p>
                  </div>
          ...
          <Card className="col-span-3">
            ...
            <CardContent className="space-y-2">
              ...
              <button className="w-full text-left p-3 rounded-lg border hover:bg-muted transition-colors">
                <div className="font-medium">Review Fundraisers</div>
                <div className="text-sm text-muted-foreground">
