...
const HomeContent = ({ isAuthenticated }: { isAuthenticated: boolean }) => (
  <div className="min-h-[calc(100vh-69px)] flex flex-col items-center justify-center bg-background px-4">
    <main className="flex items-center gap-8 max-w-[1000px] flex-wrap justify-center h-[calc(100vh-69px)]">
    ...
    <section className="w-full max-w-6xl mx-auto px-4 py-16 bg-gray-50/50">
      <div className="text-center mb-16">
        ...
        <blockquote className="text-lg text-gray-700 italic leading-relaxed max-w-4xl mx-auto">
          &ldquo;Trust is earned through transparency. Transparency is achieved
      ...
      <section className="w-full max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center group">
            ...
            <p className="text-gray-600 leading-relaxed">
              We pledge to provide complete <strong>transparency</strong> about
              where your money goes, verify every story we feature, and protect
              your generous contributions from fraud.
            </p>
          </div>
          <div className="text-center group">
